...
// دالة البحث الفوري مع تحديد الجدول
...
function initInstantSearch() {
    ...
    if (searchInput1) {
        ...
        // زر إعادة تعيين
        addResetButton(searchInput1, 'documentsTableIncomplete', 'tableSearchInfo1', 'searchResultsCount1');
    }
    ...
    if (searchInput2) {
        ...
        addResetButton(searchInput2, 'documentsTableCompleted', 'tableSearchInfo2', 'searchResultsCount2');
    }
}

// دالة مساعدة لإضافة زر إعادة تعيين داخل حقل البحث
function addResetButton(searchInput, tableId, infoId, resultsCountId) {
    const resetBtn = document.createElement('button');
    resetBtn.innerHTML = '<i class="fas fa-times"></i>';
    resetBtn.style.cssText = 'position:absolute; left:35px; top:50%; transform:translateY(-50%); background:none; border:none; color:#95a5a6; cursor:pointer; display:none;';
    resetBtn.addEventListener('click', function() {
